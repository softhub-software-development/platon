...
pos_save_dir = data_dir + '/val/12/positive'
part_save_dir = data_dir + '/val/12/part'
neg_save_dir = data_dir + '/val/12/negative'
...
f1 = open(os.path.join(data_dir, 'pos_12_val.txt'), 'w')
f2 = open(os.path.join(data_dir, 'neg_12_val.txt'), 'w')
f3 = open(os.path.join(data_dir, 'part_12_val.txt'), 'w')
