...
#train_path = 'data/imglist_anno_24.txt'
train_path = data_dir + '/imglist_anno_24_val.txt'
val_path = data_dir + '/imglist_anno_24_val.txt'
batch_size = 64
print('start loading dataset from ' + train_path + ' batch size ' + str(batch_size))
sys.stdout.flush()
dataloaders = {
...
train_logging_file = 'log/onet.log'
...
torch.save(model.state_dict(), '../weights/onet_eu')
