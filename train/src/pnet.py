...
#train_path = data_dir + '/imglist_anno_12.txt'
train_path = data_dir + '/imglist_anno_12_val.txt'
val_path = data_dir + '/imglist_anno_12_val.txt'
batch_size = 64
dataloaders = {
...
train_logging_file = 'log/pnet.log'
...
torch.save(model.state_dict(), '../weights/pnet_eu')
