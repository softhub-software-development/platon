...
if __name__ == '__main__':
    train_path = 'data/imglist_anno_12.txt'
    val_path = 'data/imglist_anno_12_val.txt'
    print("training set size: " + len(ListDataset(train_path)))
    batch_size = 8
    dataloaders = {
    ...
    for i_batch, sample_batched in enumerate(dataloaders['train']):
        images_batch, label_batch, bbox_batch, landmark_batch = sample_batched[
            'input_img'], sample_batched['label'], sample_batched['bbox_target'], sample_batched['landmark']
